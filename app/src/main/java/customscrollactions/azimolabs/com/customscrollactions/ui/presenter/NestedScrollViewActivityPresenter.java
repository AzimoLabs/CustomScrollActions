...
public class NestedScrollViewActivityPresenter {

    private NestedScrollViewActivity view;
    private MockDataRepository dataRepository;

    public NestedScrollViewActivityPresenter(NestedScrollViewActivity view,
